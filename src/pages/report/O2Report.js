    ...
    <button className="import_button_text_o2" onClick={handleFileImport}>
      ...
      <div className="page">
        ...
        <div className="info_border">
          ...
          <input type="text" className="name_input" placeholder="Enter Name"/>
          <div className="age">Age: </div>
          <input type="number" className="age_input" min="1" max="100" placeholder="Enter Age" 
          onInput={(event) => {
        ...
        <div className="start">Start Time: {startTime ? startTime : "-" }</div>
        ...
        <div className="note_border">
          <div className="note">
            <textarea type="text" className="note_input"  placeholder="Note: " rows="5" maxlength="800"/>
          </div>
        </div>
