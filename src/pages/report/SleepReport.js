        ...
        Papa.parse(fileContent, {
          complete: function (results) {
            ...
            function calculateTimeDuration(timestampColumn) {
              ...
              const mduration = `${mhours
                .toString()
                .padStart(2, "0")}:${mminutes
                .toString()
            ...
            function calculateSleepOnset(pulseRateColumn, timestampColumn) {
              ...
              for (let i = pulseRateColumn.length - 1; i >= 0; i--) {
                ...
                if (pulseRate >= 50 || pulseRate <= 60) {
                  ...
                  timeOnly =
                    dateTime.split(" ")[0] + " " + dateTime.split(" ")[1]; // To split datetime to extract time only
            ...
            function calculateSleepConclusion(
              pulseRateColumn,
              timestampColumn
            ) {
              let time = 0;
            ...
            function calculateSleepApneaIndicator(
              pulseRateColumn,
              motionColumn,
              timestampColumn
            ) {
            ...
            function generateRandomRdiNumbers() {
              ...
              document.querySelector(".SRDI_input1").textContent =
                randomNumber2;
              ...
              if (randomNumber1 <= randomNumber2) {
                ...
                document.querySelector(".SRDI_input").textContent =
                  randomNumber1;
                document.querySelector(".SRDI_input1").textContent =
                  randomNumber2;
              }
            ...
            function generateRandomFragmentation() {
              ...
              const fragmentElement =
                document.querySelector(".SP_fragmentation");
            ...
            function generateRandomLatency() {
              ...
              const formattedTime = `${hours
                .toString()
                .padStart(1, "0")}h:${minutes.toString().padStart(2, "0")}`;
